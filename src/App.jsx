...
const RootRedirect = () => {
  ...
  switch (user.role) {
    ...
    case 'WAREHOUSE_OPERATOR': return <Navigate to="/operator/dashboard" replace />;
    case 'RECEIVING_INVENTORY_OFFICER': return <Navigate to="/inventory/dashboard" replace />;
      ...
      <WarehouseProvider>
        <Router>
          <Routes>
            ...
            <Route element={<ProtectedRoute allowedRoles={['WAREHOUSE_MANAGER']} />}>
            ...
            <Route element={<ProtectedRoute allowedRoles={['WAREHOUSE_OPERATOR']} />}>
            ...
            <Route element={<ProtectedRoute allowedRoles={['RECEIVING_INVENTORY_OFFICER']} />}>
